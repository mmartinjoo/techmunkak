...
ssh -tt -o StrictHostKeyChecking=no alwyzon@203.34.137.201 "cd /home/alwyzon/techmunkak && docker compose -f docker-compose.yml -f docker-compose.prod.yml down"
